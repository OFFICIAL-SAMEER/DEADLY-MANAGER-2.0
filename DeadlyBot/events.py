...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import DeadlyBot.events

        path = Path(f"DeadlyBot/modules/{shortname}.py")
        name = "DeadlyBot.modules.{}".format(shortname)
        ...
        mod.DeadlyBot = DeadlyBot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["DeadlyBot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "DeadlyBot/modules/*.py"
