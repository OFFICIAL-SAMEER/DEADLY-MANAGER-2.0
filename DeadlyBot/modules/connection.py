...
import DeadlyBot.modules.sql.connection_sql as sql
from DeadlyBot import dispatcher, DRAGONS, DEV_USERS
from DeadlyBot.modules.helper_funcs import chat_status
